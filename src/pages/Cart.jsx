...
const Cart = () => {
  ...
  const onRemoveCartItem = (id) => {
    if (window.confirm('Вы точно хотите удалить данную позицию?')) {
  ...
  const onClickOrder = () => {
    console.group('Ваш заказ: ', items);
    console.log('Всего пицц: ', totalCount);
            ...
            {addedPizzas.map((obj) => {
              return (
                <CartItem
                  ...
                  id={obj.id}
                  addItemToCart={onPlusCartItem}
                  minusItemCart={onMinusCartItem}
                />
              );
            })}
          </div>
